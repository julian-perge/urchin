...
def parse_move_block(move_dict: dict):
    ...
    for idx, block in move_dict.items():
        ...
        if isinstance(element_types_affected_15, dict):
            element_types_affected_15 = list(
                element_types_affected_15.get("denseValues", {}).values()
            )
        ...
        ab_two_dict = {
            ...
            "9_focus_amount_change": ability_two.get(
                "9"
            ...
            "12_heal_percent_max_health": ability_two.get(
                "12"
            ...
            "20_is_multi_target": bool(
                ability_two.get("20")
            ),  # 0 = single target, 1 = multi
        ...
        move = {
            ...
            "6_deprecated_life_check": _move_block.get(
                "g_6"
            ),  # g, legacy value always 0
            ...
            "10_attack_animation_type": _move_block.get(
                "k_10"
            ),  # k, "Melee", "Missile", "Shock"
            ...
            "14_effect_category": _move_block.get(
                "o_14"
            ),  # o, Full damage / Heal / Focus
            "15_deprecated_flag": _move_block.get("p_15"),  # p, legacy value always 1
            "16_health_cost_percentage": _move_block.get("q_16"),  # q
            "17_localized_name": _move_block.get(
                "r_17"
            ),  # r, _root.KrinLang[KLangChoosen].SKILLNAME[skill_name];, tooltip title
...
def convert_to_json(input_file, output_file):
    ...
    with open("converted_json/converted_moves_by_id.json", "w") as f2:
        ...
        for _i in all_moves:
            ...
            ids_objs.update({_i.get("1_id"): _val})
