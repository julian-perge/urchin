on(press){
   ...
   if(_root["KRINITEM" + _root.Krin.mouseItem][1] == IPS)
   {
      ...
      if(IPS == 8)
      {
         if(_root["KRINITEM" + _root.Krin["equipArray" + _root.Krin.MenuPlayerSelect][5]][1] == 9)
         {
            ewfewgrvd = 2;
         }
      }
   }
   if(_root["KRINITEM" + _root.Krin.mouseItem][1] == 9 && IPS == 7)
   {
      vniwbovdnb = 1;
      if(_root.Krin["equipArray" + _root.Krin.MenuPlayerSelect][6] != 0)
      {
         ewfewgrvd = 1;
      }
   }
   ...
   if(_root["KRINITEM" + _root.Krin.mouseItem][4] <= _root.Krin.LevelStats[_root.Krin.MenuPlayerSelect] && hivhbwerhvgwr + vniwbovdnb == 2 && ewfewgrvd == 0 || _root.Krin.mouseItem == 0)
   {
      ...
      if(_root.Krin["equipArray" + _root.Krin.MenuPlayerSelect][id] != 0)
      {
         for(p in _root.Krin["StatSets" + _root.Krin.MenuPlayerSelect])
         {
            _root.Krin["StatSets" + _root.Krin.MenuPlayerSelect][p] += _root["KRINITEM" + _root.Krin["equipArray" + _root.Krin.MenuPlayerSelect][id]].statUpdater[p];
   ...
   else
   {
      ...
      {
         _root.KrinCombatText.combatTexter = _root.KrinLang[_root.KLangChoosen].ITEMERROR4;
      }
      else if(ewfewgrvd == 2)
      {
         _root.KrinCombatText.combatTexter = _root.KrinLang[_root.KLangChoosen].ITEMERROR5;
      }
      else
      {
