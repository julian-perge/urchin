...
def parse_buff_block(buff_dict: dict):
    ...
    for idx, block in buff_dict.items():
        ...
        buff = {
            ...
            "26_sswitch_delta": hack_move.get("26"),  # flips healing/damage on the affected unit
...
if __name__ == "__main__":
    buffs_count = convert_to_json("data_json/swf_buffs.json", "converted_json/buffs.json")
