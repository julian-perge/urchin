...
#
# Run: uv run python3 python_conversion_scripts/swf_extraction/extract_start_screens.py
import sys
...
from swf_xml_lib import SOURCE_FILES  # noqa: E402

REPO = Path(__file__).resolve().parent.parent.parent
FRAMES = SOURCE_FILES / "exported_assets" / "frames"
OUT_MENU = REPO / "assets" / "ui" / "menu"
ZOOM = 2.0
