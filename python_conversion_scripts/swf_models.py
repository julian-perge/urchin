...
# python_conversion_scripts/data_json/. The dumps wrap every AS value in one
...
DATA_JSON = REPO_ROOT / "python_conversion_scripts" / "data_json"
CONVERTED_JSON = REPO_ROOT / "python_conversion_scripts" / "converted_json"
...
AmfValue = Union[EcmaArray, AmfObject, Undefined]
